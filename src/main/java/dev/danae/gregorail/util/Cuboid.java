...
public final class Cuboid
{
  ...
  public static Entity findNearestEntity(Location center, int radius, Predicate<Entity> predicate)
  {
    return Cuboid.of(center, radius).findNearestEntityToCenter(predicate);
  }
  
  // Get the nearest entity of the specified class at a location
  public static <T extends Entity> T findNearestEntity(Location center, int radius, Class<T> cls)
  {
    return Cuboid.of(center, radius).findNearestEntityToCenter(cls);
  }
  
  // Get the nearest entity of the specified class and that matches the predicate at a location
  public static <T extends Entity> T findNearestEntity(Location center, int radius, Class<T> cls, Predicate<T> predicate)
  {
    return Cuboid.of(center, radius).findNearestEntityToCenter(cls, predicate);
  }
